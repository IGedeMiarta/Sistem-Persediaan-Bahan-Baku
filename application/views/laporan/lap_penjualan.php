    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                ...
                ?>
                    <a class='btn btn-primary' target="_blank" href='<?php echo base_url() . 'report/penjualan_print?tanggal_mulai=' . $mulai . '&tanggal_sampai=' . $sampai ?>'><i class='fa fa-print'></i> CETAK</a>
                <?php
                }
                ?>
            </div>
